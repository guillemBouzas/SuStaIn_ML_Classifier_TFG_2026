...
# Limitem els valores al rang [-5, 5] perquè coincideixin Z_vals y Z_max
...
N_startpoints = 10
N_S_max = 4 # Aquí per canviar quants subtipus li posem (N_S_max = control + n_subtipus)
...
# Boxplots
vars_to_plot = ['Composite_Summary', 'AGE_REAL', 'total_TAU_real', 'hippocampus', 'cerebral cortex']
